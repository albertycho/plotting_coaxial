...
if infile in os.listdir('.'):
    ...
    ifig,(iax0,iax1,iax2)=plt.subplots(3, gridspec_kw={'height_ratios': [1,2,1]})
    ...
    barwidth = 0.3
    alval=1
    iax0.bar(X_axis, ipc_gains, edgecolor='black', alpha=alval, color=color_list[0], width=barwidth, zorder=5)
    

    iax0.set_xticks([], [])
    iax0.set_ylabel('Normalized Performance', fontsize=20)
    iax0.set_ylim(0,200)
    ...
    iax1.set_ylim(0,200)
    iax1.text(-0.5,190,'356ns',zorder=5, fontsize=12, bold=True)

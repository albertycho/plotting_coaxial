...
if('2' in stype):
    ...
    print('PLOTTING 10ns50ns')
    is2X=False
else:
    print('type was not specified. PLOTTING 2X8X by default')
    is2X=True
...
if infile in os.listdir('.'):
    ...
    plt.ylabel('Normalized Performance',fontsize=16, labelpad=10)
    ...
    if(is2X):
        ...
        ifig.savefig('1050ns_plot.png', bbox_inches='tight')

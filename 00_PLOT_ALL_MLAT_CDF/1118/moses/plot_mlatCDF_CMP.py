...
linewidth=12
plt.plot(cdf_x_axis,mlat_cdf_DDR, label="DDR", linewidth=linewidth, color=color_list[2])
plt.plot(cdf_x_axis,mlat_cdf_CXL, label="CXL", linewidth=linewidth , color=color_list[5])
...
iax.text(50,1.1,'DDR stdev: 222\nCXL  stdev: 100',zorder=5, fontsize=90, ha='left',bbox=props);
#%raw data: DDR avg, DDR stdev, CXL avg, CXL stdev
#% perlbench: 55.4	49.9	81.7	46.9
#% Moses: 262.5	222.0	124.0	99.9
...
ifig.savefig('mem_lat_cdf_cut600.png', bbox_inches='tight')
